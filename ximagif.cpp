...
bool CxImageGIF::Encode(CxFile * fp)
{
	...
	if(head.biBitCount > 8)	{
		//strcpy_s(info.szLastError,sizeof(info.szLastError),"GIF Images must be 8 bit or less");
		//return FALSE;
		return EncodeRGB(fp);
	}
...
void CxImageGIF::output( code_int  code)
{
	...
	if( code == EOFCode ) {
		...
		if(g_outfile->Error()) strcpy_s(info.szLastError,sizeof(info.szLastError),"Write Error in GIF file");
	}
}
////////////////////////////////////////////////////////////////////////////////
...
{	if (sz_comment_in) strncpy_s(m_comment,255,sz_comment_in,255); }
////////////////////////////////////////////////////////////////////////////////
void CxImageGIF::GetComment(char* sz_comment_out)
{	if (sz_comment_out) strncpy_s(sz_comment_out,255,m_comment,255); }
////////////////////////////////////////////////////////////////////////////////
